...
class Divipole(models.Model):
    divipole = models.IntegerField(db_column='DIVIPOLE', blank=True, null=True)  # Field name made lowercase.
    ...
    municipio_1 = models.CharField(db_column='MUNICIPIO_1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    nombre_puesto = models.CharField(db_column='NOMBRE PUESTO', max_length=50, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
